...
public class Customer {
    ...
    public Customer(Integer customerId,Integer companyId,String customerPhone,String customerType,java.util.Date customerCreateTime,String customerSex,java.util.Date customerBirthday,String customerName) {
        super();
